...
_$LoadImpl _$$LoadImplFromJson(Map<String, dynamic> json) => _$LoadImpl(
  ...
  assignedTruck: json['assignedTruck'] as String?,
...
Map<String, dynamic> _$$LoadImplToJson(_$LoadImpl instance) =>
    <String, dynamic>{
      ...
      'assignedTruck': instance.assignedTruck,
...
_$CargoImpl _$$CargoImplFromJson(Map<String, dynamic> json) => _$CargoImpl(
...
Map<String, dynamic> _$$CargoImplToJson(_$CargoImpl instance) =>
    <String, dynamic>{
