...
| jspdf-autotable | high | via jspdf | 2.0.9 - 2.1.0 || 2.3.3 - 3.8.4 | {"name":"jspdf-autotable","version":"5.0.2","isSemVerMajor":true} |
| dompurify | moderate | GHSA-vhxf-7vqr-mrjg | <3.2.4 | {"name":"jspdf","version":"3.0.3","isSemVerMajor":true} |
| esbuild | moderate | GHSA-67mh-4wv8-2f99 | <=0.24.2 | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |
| vite | moderate | via esbuild | 0.11.0 - 6.1.6 | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |
| vite-node | moderate | via vite | <=2.2.0-beta.2 | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |
| @vitest/mocker | moderate | via vite | <=3.0.0-beta.4 | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |

### Patch/Minor updates available

| Package | Current | Wanted | Latest | Update Type |
|---|---|---|---|---|
| @tanstack/react-query | 5.90.2 | 5.90.3 | 5.90.3 | patch |
| playwright | 1.55.1 | 1.56.0 | 1.56.0 | minor |
| next-seo | 6.5.0 | 6.5.0 | 6.8.0 | minor |
| @supabase/supabase-js | 2.58.0 | 2.75.0 | 2.75.0 | minor |
...
|---|---|---|---|
| @sentry/nextjs | 8.55.0 | 10.19.0 | Potential breaking changes |
| @types/node | 20.19.19 | 24.7.2 | Potential breaking changes |
| @types/react | 18.3.25 | 19.2.2 | Potential breaking changes |
| @types/react-dom | 18.3.7 | 19.2.2 | Potential breaking changes |
| eslint | 8.57.1 | 9.37.0 | Potential breaking changes |
| eslint-config-next | 14.2.33 | 15.5.5 | Potential breaking changes |
| lucide-react | 0.452.0 | 0.545.0 | Potential breaking changes |
| maplibre-gl | 3.6.2 | 5.9.0 | Potential breaking changes |
| next | 14.2.33 | 15.5.5 | Potential breaking changes |
| pino | 9.13.1 | 10.0.0 | Potential breaking changes |
| react | 18.3.1 | 19.2.0 | Potential breaking changes |
| react-dom | 18.3.1 | 19.2.0 | Potential breaking changes |
| react-window | 1.8.11 | 2.2.1 | Potential breaking changes |
| recharts | 2.15.4 | 3.2.1 | Potential breaking changes |
| tailwindcss | 3.4.18 | 4.1.14 | Potential breaking changes |
| tesseract.js | 5.1.1 | 6.0.1 | Potential breaking changes |
| vitest | 2.1.9 | 3.2.4 | Potential breaking changes |
| zod | 3.25.76 | 4.1.12 | Potential breaking changes |
...
| jspdf | high | GHSA-8mvj-3j78-4qmw | <=3.0.1 | {"name":"jspdf","version":"3.0.3","isSemVerMajor":true} |
| jspdf-autotable | high | via jspdf | 2.0.9 - 2.1.0 || 2.3.3 - 3.8.4 | {"name":"jspdf-autotable","version":"5.0.2","isSemVerMajor":true} |
| xlsx | high | GHSA-4r6h-8v6p-xvw6 | <0.19.3 | No |
| xlsx | high | GHSA-5pgg-2g8v-p4x9 | <0.20.2 | No |
| electron | moderate | GHSA-vmqv-hx8q-j7mg | <35.7.5 | {"name":"electron","version":"38.2.2","isSemVerMajor":true} |
| esbuild | moderate | GHSA-67mh-4wv8-2f99 | <=0.24.2 | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |
| vite/vite-node/vitest | moderate | via esbuild | see advisories | {"name":"vitest","version":"3.2.4","isSemVerMajor":true} |
| @inquirer/editor | low | via external-editor | <=4.2.15 | Yes |
| @inquirer/prompts | low | via @inquirer/editor | <=6.0.1 | Yes |
| tmp | low | GHSA-52f5-9888-hmc6 | <=0.2.3 | Yes |

### Patch/Minor updates available

| Package | Current | Wanted | Latest | Update Type |
|---|---|---|---|---|
| @supabase/supabase-js | 2.57.2 | 2.57.4 | 2.75.0 | minor |
| ioredis | 5.8.0 | 5.3.2 | 5.8.1 | patch |
| qrcode | 1.5.3 | 1.5.3 | 1.5.4 | patch |
| ts-jest | 29.4.1 | 29.2.6 | 29.4.4 | patch |
| typescript | 5.9.2 | 5.6.3 | 5.9.3 | patch |
...
| Package | Current | Latest | Note |
|---|---|---|---|
| @types/node | 20.19.17 | 24.7.2 | Potential breaking changes |
| @types/react | 18.3.26 | 19.2.2 | Potential breaking changes |
| concurrently | 8.2.2 | 9.2.1 | Potential breaking changes |
| electron | 28.3.3 | 38.2.2 | Potential breaking changes |
...
| next | 14.2.32 | 15.5.5 | Potential breaking changes |
...
No vulnerabilities reported by native tooling (no lockfile present for `npm audit`).

No patch/minor updates reported.
...
Note: Based on `dart pub outdated`, these are examples of packages with non-major updates available. Evaluate each in context.
...
| meta | 1.16.0 | 1.17.0 | 1.17.0 | minor |
...
| test_api | 0.7.6 | 0.7.7 | 0.7.7 | patch |
