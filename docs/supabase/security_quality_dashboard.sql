-- ALERTS (source objects tied to escalations/retests)
...
-- RETESTS (track verification of fixes)
...
-- Optional narrow “retests_view” to simplify card queries
...
-- Quarterly effectiveness: how many remediations verified (pass rate)
...
-- RLS: enable and keep permissive samples (tighten to your tenancy model)
